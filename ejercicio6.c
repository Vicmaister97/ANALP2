/***********************************************************/
/* Programa: P2_6                  Fecha: 10/11/2016       */
...
int main(int argc, char** argv)
{
  ...
  printf("Practica numero 2, apartado 6\n");
  ...
  ret = genera_tiempos_ordenacion(quicksort_stat, nombre, num_min, num_max, incr, n_perms);
